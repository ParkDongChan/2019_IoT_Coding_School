...
#define DEVICE_ID "737ea410b09d404cb303fd8b4461ec34" //FIX
#define DEVICE_TOKEN "ae27257454d3434ab3ab99f311fa8b06" // FIX
#define ACTION_TOPIC "/v1.1/actions/737ea410b09d404cb303fd8b4461ec34" // FIX
#define MESSAGE_TOPIC "/v1.1/messages/737ea410b09d404cb303fd8b4461ec34" //FIX
...
int main(int argc, char *argv[])
{
	...
	while (mqttSubscribe == false )
	{
		...
		while (1)
		{
			...
			sprintf(tempBuf,"\"IR Sensor\":%.1d", val ); strcat(str,tempBuf); strcat(str,"}}");
